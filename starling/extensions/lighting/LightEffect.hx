...
class LightEffect extends MeshEffect
{
    ...
    {
        var vertexShader : Array<Dynamic> = [
    ...
    {
        var normalMapBits : Int = RenderUtil.getTextureVariantBits(_normalTexture);
    ...
    private function set_numLights(value : Int) : Int
    {
        ...
        //as3hx.Compat.setArrayLength(_lights, value);
        return value;
    }
    
    public function setLightAt(index : Int, type : String, color : Int,
...
class Light
{
    ...
    public function new(color : Int = 0xffffff, type = "")
    {
        x = y = z = 0.0;
        this.color = color;
        this.type = type;
