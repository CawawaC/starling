...
class LightStyle extends MeshStyle
{
    ...
    {
        var litMeshStyle : LightStyle = try cast(meshStyle, LightStyle) catch(e:Dynamic) null;
        if (litMeshStyle != null)
        {
            ...
            numVertices : Int = -1) : Void
    {
        ...
        if (matrix != null)
        {
            ...
            var targetLightStyle : LightStyle = try cast(targetStyle, LightStyle) catch(e:Dynamic) null;
    ...
    {
        var litMeshStyle : LightStyle = try cast(meshStyle, LightStyle) catch(e:Dynamic) null;
        if (litMeshStyle != null && super.canBatchWith(meshStyle))
        {
    ...
    {
        var lightEffect : LightEffect = try cast(effect, LightEffect) catch(e:Dynamic) null;
    ...
    private function set_normalTexture(value : Texture) : Texture
    {
        if (value != _normalTexture)
        {
            if (target != null)
            {
                for (i in 0...vertexData.numVertices)
                {
                    getTexCoords(i, sPoint);
                    if (value != null)
                    {
